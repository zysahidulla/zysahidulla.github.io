...
const achievements = [
  ...
  {
    title: 'With Honors',
    description: 'Consistent honor student throughout Elementary and High School',
    icon: Trophy,
    year: '2013-2019',
    color: 'secondary',
  },
  {
    ...
    description: 'Consistent high honor student throughout last of High School and Senior High School',
    icon: Crown,
    year: '2020-2023',
    color: 'primary',
  },
  {
    ...
    description: 'Outstanding contributor to school publications as the Managing Editor',
    icon: Medal,
    year: '2023',
    color: 'secondary',
  },
  {
    ...
    description: 'Maintained good conduct and discipline record throughout school years',
    icon: Award,
    year: '2019-2023',
    color: 'primary',
  },
  {
    ...
    description: 'Best in Computer Subject in Grade School, showcasing early passion for technology',
    icon: Sparkles,
    year: '2016',
    color: 'secondary',
  },
