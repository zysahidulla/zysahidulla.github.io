      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="text-center lg:text-left">
            ...
            <motion.p
              variants={itemVariants}
              className="text-lg md:text-xl text-muted-foreground mb-10 line-clamp-none"
            >
              I don't just write code—I design experiences where creativity and engineering collide.
            </motion.p>
            ...
            >
              <motion.a
                href="#projects"
                className="group px-8 py-4 rounded-full bg-primary text-primary-foreground font-semibold text-lg flex items-center gap-2 hover:glow-primary transition-all duration-300"
              ...
              <motion.a
                href="#contact"
                className="px-8 py-4 rounded-full glass-card border-gradient font-semibold text-lg text-foreground hover:bg-muted/20 transition-all duration-300"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Get In Touch
          ...
          >
            ...
            >
              {/* Soft glow effect - blends with background */}
